...
# Get the absolute path of Matthias_Decoder
base_path = "/Users/khavishgovind/Documents/Git_Repos/SAR_Radar_RIT/Matthias_Decoder"

# Add Spectogram_Programs to sys.path
sys.path.append(os.path.join(base_path, "Spectogram_Programs"))

# Now import the function
import Spectogram_FunctionsV3

file_path = '/Users/khavishgovind/Documents/Git_Repos/SAR_Radar_RIT/Matthias_Decoder/Matlab_Simulator/radar_data_modified.mat'
data = loadmat(file_path)  # Load the .mat file
radar_data = data['radar_data']  # Extract the matrix

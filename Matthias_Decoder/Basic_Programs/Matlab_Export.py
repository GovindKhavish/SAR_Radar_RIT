...
print(radar_data[:10, :])  # NumPy array
...
folder_path = r'/Users/khavishgovind/Library/CloudStorage/OneDrive-UniversityofCapeTown/Masters/CSV_Files'  # Adjust this to your folder path
file_name = 'radar_data_Mipur.mat'
file_path = os.path.join(folder_path, file_name)

# Save radar_data as a .mat file
scipy.io.savemat(file_path, {'radar_data': radar_data})

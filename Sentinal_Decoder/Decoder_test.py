...
#------------Dimona--------------#
filepath = "/Users/khavishgovind/Documents/Masters/Data/Dimona/S1A_IW_RAW__0SDV_20190219T033540_20190219T033612_025993_02E57A_771F.SAFE/"
...
#------------Sao Paulo--------------#
#filepath = "/Users/khavishgovind/Documents/Masters/Data/Sao_Paulo/Sao_Paulo_VV_VH/S1B_IW_RAW__0SDV_20210216T083028_20210216T083100_025629_030DEF_1684.SAFE/"
...
#HV Polarisation
#filename = "s1a-s3-raw-s-hv-20230518t213602-20230518t213627-048593-05d835.dat"

#------------New York--------------#
#filepath = "/Users/khavishgovind/Documents/Masters/Data/New_York/S1A_IW_RAW__0SDH_20240610T105749_20240610T105815_054260_069997_EFB1.SAFE/"

#HH Polarisation
#filename = "s1a-iw-raw-s-hh-20240610t105749-20240610t105815-054260-069997.dat"
#HV Polarisation
#filename = "s1a-iw-raw-s-hv-20240610t105749-20240610t105815-054260-069997.dat"

#------------Augsburg--------------#
#filepath = "/Users/khavishgovind/Documents/Masters/Data/Augsburg/S1B_IW_RAW__0SDH_20210320T052559_20210320T052623_026094_031D16_F119.SAFE/"

#HH Polarisation
#filename = "s1b-iw-raw-s-hh-20210320t052559-20210320t052623-026094-031d16.dat"
#HV Polarisation
#filename = "s1b-iw-raw-s-hv-20210320t052559-20210320t052623-026094-031d16.dat"


inputfile = filepath + filename
l0file = sentinel1decoder.Level0File(inputfile)

# Print metadata and ephemeris for debugging
...
print("Burst metadata:", selection)
print("Burst metadata shape:", selection.shape)

# Decode the IQ data
print("Starting to decode the burst data...")
radar_data = l0file.get_burst_data(selected_burst)
print("Decoding completed.")

# Inspect the radar data
print("Radar data shape:", radar_data.shape)
print("Radar data sample (1st element):", radar_data.flatten()[0])
print("Radar data sample (first 10 elements):", radar_data.flatten()[:10])

# Cache the data if needed for faster retrieval next time
...
plt.imshow(abs(radar_data[:,:]), vmin=0, vmax=15, origin='lower',aspect='auto')
plt.xlabel("Fast Time (down range)")
plt.ylabel("Slow Time (cross range)")
plt.show()

# Use a logarithmic normalization for better visualization
